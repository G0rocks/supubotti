...
frameWidth = 640
frameHeight = 480
cap = cv2.VideoCapture(1) #finna rétt gildi fyrir myndavél
...
try:
    while True:
        ...
        if verify_y > 20:
          verify_y = 0 #Hér mun koma kóði sem lætur robotinn fara af stað
          aspas_counter = 0
          print("Tomatsupa!")
        elif aspas_counter > 19:
          verify_y = 0
          aspas_counter = 0
          print("Aspas supa")
